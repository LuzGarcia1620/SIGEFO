...
class FormService
{
    ...
    public function saveForm(BeanArea $beanArea, BeanInstructor $beanInstructor, BeanActivity $beanActivity, $idRecurso)
    {
        ...
        try {
            ...
            $stmt->bindValue(15, $beanActivity->getStatus());
            $stmt->bindValue(16, $beanActivity->getIdClasificacion());
            $stmt->bindValue(17, $beanActivity->getIdModalidad());
            $stmt->bindValue(18, $beanActivity->getDirigidoA());
            $stmt->bindValue(19, $beanActivity->getPerfilIngreso());
            $stmt->bindValue(20, $beanActivity->getPerfilEgreso());
            $stmt->bindValue(21, $beanActivity->getObjetivo());
            $stmt->bindValue(22, $beanActivity->getTemario());
            $stmt->bindValue(23, $beanActivity->getCupo());
            $stmt->bindValue(24, $beanActivity->getPresentacion());
            $stmt->bindParam(25, $idRecurso);
