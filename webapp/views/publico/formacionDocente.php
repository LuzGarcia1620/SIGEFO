                ...
                <div class="col-md-6 d-flex justify-content-center">
                    <div class="card card-custom">
                        <div class="card-header card-header-custom">
                            La Universidad Autónoma del Estado de Morelos, la Secretaría Académica a través de la
                            Dirección
                            General de Educación Superior
                        </div>
                        <div class="card-body card-body-custom">
                            <h5 class="card-title"><?= htmlspecialchars($activity['modalidad']) ?></h5>
                            <h2 class="card-text"><?= htmlspecialchars($activity['nombre']) ?></h2>
                            <p class="card-text"><?= htmlspecialchars($activity['dirigidoA']) ?></p>
                            <a href="/SIGEFO/informacion" class="inscriptionbtn">Ver más información</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
